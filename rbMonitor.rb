...
after :pin => 23, :goes => :high do
  ...
  file_name = "#{IMAGE_DIRECTORY}/person-#{Time.now.to_i}.jpg"
	...
	`curl --request POST --data-binary @"#{file_name}" --header "U-ApiKey: 824d86075f2b76ea2299951233a53528" http://api.yeelink.net/v1.1/device/13547/sensor/22418/datapoints`
